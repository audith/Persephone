 ...
 * Last Updated: $Date: 2009-05-29 23:46:52 -0400 (Fri, 29 May 2009) $
 *
...
class customFieldText extends customFieldPlugin implements interfaceCustomFieldPlugin
{
	 ...
	 * CONSTRUCTOR
	 *
	 * @param     array 	Array of field data { id, data, value, class }
	 * @param     string	Set to 'view' or 'edit'
	 * @return    void
	 **/
...
class classCustomFields
{
	...
	public function getFieldsToSave ( $input_array )
	{
		...
		foreach ( $this->field_list as $field )
		{
			...
			{
				/* Size Restriction */
				if ( $field['restrictions']['max_size'] && mb_strlen( $submit_value, "UTF-8" ) > $field['restrictions']['max_size'] )
				{
					$errors[ 'field_' . $field['id'] ][] = 'too_big';
				}

				/* Size Restriction */
				if ( $field['restrictions']['min_size'] && mb_strlen( $submit_value, "UTF-8" ) < $field['restrictions']['min_size'] )
				{
					$errors[ 'field_' . $field['id'] ][] = 'too_small';
				}

				/* Null restriction */
				if ( $field['restrictions']['not_null'] && ! $submit_value )
				{
	 ...
	 *
	 * @param     array     Array of field data
	 * @param     string    View/Edit, or blank for class default
	 * @return    object
	 **/
