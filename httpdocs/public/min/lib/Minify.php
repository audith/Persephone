...
class Minify
{
	 ...
	 * NOT set, then serve() will check CSS files for
	 *
	 * @import declarations that
	 ...
	 * 'bubbleCssImports' : If true, all
	 *
	 * @import declarations in combined CSS
	 ...
	 * Bubble CSS
	 *
	 * @imports to the top or prepend a warning if an import is detected not at the top.
	 *
	 * @param string $css
	 *
	 * @return string
